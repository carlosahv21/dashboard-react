  ...
  const donutOption = useMemo(() => {
    ...
    return {
      tooltip: {
        trigger: "item",
        formatter: (params) => {
          return `${params.name}: ${formatCurrency(params.value, settings)} (${
            params.percent
          }%)`;
        },
      },
    ...
    return {
      ...
      yAxis: [
        ...
        },
        {
          ...
          axisLabel: {
            formatter: (value) => formatCurrency(value, settings, false),
          },
          splitLine: {
            show: false,
          },
      ...
      series: [
        ...
        },
        {
          ...
          type: "bar",
          yAxisIndex: 1,
          data: paymentMethodAnalysis.map((i) =>
            parseFloat(i.avg_transaction)
          ),
