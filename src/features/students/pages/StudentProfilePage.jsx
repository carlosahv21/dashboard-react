    ...
    <div style={{ minHeight: "100vh" }}>
      <div style={{ display: "flex", alignItems: "center", marginBottom: 32 }}>
        ...
        <Title level={2} style={{ margin: 0 }}>
          {t("students.profile_view", { defaultValue: "Perfil del Estudiante" })}
        </Title>
      </div>
      ...
      <Row gutter={[24, 24]}>
        ...
        <Col xs={24} lg={8}>
          <Space direction="vertical" size="large" style={{ width: '100%' }}>
            ...
            {/* Acciones */}
            <Card title={t('global.actions')}>
               <Space direction="vertical" style={{ width: '100%' }}>
                 <Button block icon={<HistoryOutlined />} onClick={() => navigate(`/students/${id}/history`)}>
                   {t('students.viewFullHistory', { defaultValue: "Ver Historial Completo" })}
                 </Button>
               </Space>
            </Card>
          </Space>
