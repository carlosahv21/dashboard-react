...
const LoginPage = () => {
    ...
    const handleLogin = async (values) => {
        ...
        try {
            ...
            // Pasamos el objeto data interno que contiene token, user, academy, etc.
            login(result.data);
            navigate("/");
        } catch (err) {
            const msg =
            ...
            <nav className="dance-nav">
                ...
                <div className="dance-nav-actions">
                    <div className="dance-nav-links">
                        <a className="dance-nav-link" href="#">
                            {t("auth.navHome")}
                        </a>
                        <a className="dance-nav-link" href="#">
                            {t("auth.navClasses")}
